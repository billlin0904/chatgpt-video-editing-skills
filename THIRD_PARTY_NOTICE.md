...
本 Repo 只提供 Agent Skills、提示詞與文件，不內含下列上游專案的程式碼、模型、套件、字體或服務。使用者自行安裝或呼叫的第三方內容，仍分別受其上游授權與服務條款約束：
...
各名稱、商標、程式碼、服務與內容仍歸各自權利人所有。本專案的 MIT License 不會取代、擴張或重新授權任何第三方內容。
